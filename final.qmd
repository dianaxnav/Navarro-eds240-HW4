...
packing <- ggplot() + 
  ...
  #set the title 
  labs(title = "Banana Index Ratio: Average Greenhouse Gas Emissions by Food Group in 2022",
...
connected <- connected +
  plot_annotation(
    ...
    #set the title 
    title = "Breakdown of GHG Emissions(kg) from the Three Highest Banana Index Values of the Food Groups",
